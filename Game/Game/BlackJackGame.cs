...
namespace Game
{
    public class BlackJackGame
    {
        ...
        // Constructor that that doesnt need a set penetration, instead updates penetration as game goes (actually havent implemented that yet)
        public BlackJackGame(int roundsToPlay, IList<Player> players, Deck deck)
        {
            this.players = players;
            this.roundsToPlay = roundsToPlay;
